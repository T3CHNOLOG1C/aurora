...
// Real SDK software-synthesized "wide" button values (not raw hardware bits;
// used only via 64-bit fields such as melee's gm controller_map, computed by
// gm_EvaluateAllControllerInputs()). Matches extern/dolphin/include/dolphin/pad.h.
